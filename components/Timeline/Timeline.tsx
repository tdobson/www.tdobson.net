...
export function TimDobsonTimeline() {
  return (
      ...
      <Timeline active={1} lineWidth={6} bulletSize={60}>
        ...
        >
          <Text c="gray" size="sm">March 2022 - Present</Text>
        ...
        >
          <Text c="gray" size="sm">January 2020 - Present</Text>
          ...
          >
              <Text c="gray" size="sm">November 2017 - September 2024</Text>
        ...
        >
          <Text c="gray" size="sm">April 2018 - March 2022</Text>
        ...
        >
          <Text c="gray" size="sm">October 2018 - October 2019</Text>
        ...
        >
          <Text c="gray" size="sm">February 2019 - July 2019</Text>
        ...
        >
          <Text c="gray" size="sm">July 2017 - April 2018</Text>
        ...
        >
          <Text c="gray" size="sm">November 2010 - September 2016</Text>
